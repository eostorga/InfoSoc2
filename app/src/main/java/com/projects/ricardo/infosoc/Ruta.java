...
public class Ruta extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent mIntent;
            mIntent = new Intent(Ruta.this, MainActivity.class);
            startActivity(mIntent);
        } else if (id == R.id.nav_gallery) {
            Intent mIntent;
            mIntent = new Intent(Ruta.this, Ruta.class);
            startActivity(mIntent);
        } else if (id == R.id.nav_slideshow) {
            Intent mIntent;
            mIntent = new Intent(Ruta.this, Nivel.class);
            startActivity(mIntent);
        } else if (id == R.id.nav_manage) {
            Intent mIntent;
            mIntent = new Intent(Ruta.this, Estadistica.class);
            startActivity(mIntent);
        } else if (id == R.id.nav_share) {
            Intent mIntent;
            mIntent = new Intent(Ruta.this, About.class);
            startActivity(mIntent);
        }
